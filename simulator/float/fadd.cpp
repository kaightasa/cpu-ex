...
//	ei = (sel == 0)? e2a : e1a;
    ...
    mye = getBit32(mye, 26, 0);

	//14
	uint32_t esi; //bit数 8
	esi = getBit32(es + 1, 7, 0);
	...
	if ((mye & (1 << 26)) != 0) {
		uint32_t mydtmp;
		mydtmp = (esi == 255) ? (1 << 25): (mye >> 1);
		myd = getBit32(mydtmp, 26, 0);
	} else {
		myd = mye;
	}
	if ((mye & (1 << 26)) != 0) {
		stck = (tstck || (mye & (1 << 0))) ? 1 : 0;
	} else {
		stck = tstck;
	}
	...
	myr =  ((((myf & (1 << 1)) != 0) && ((myf & (1 << 0)) == 0) && (stck == 0) && (((myf & (1 << 2)) != 0))) ||
            (((myf & (1 << 1)) != 0) && ((myf & (1 << 0)) == 0) && (s1 == s2) && (stck == 1)) || 
            (((myf & (1 << 1)) != 0) && ((myf & (1 << 0)) != 0))) ? (getBit32(myf, 26, 2) + 1) : (getBit32(myf, 26, 2));
    myr = getBit32(myr, 24, 0);
	...
	y = ((e1 == 255)&&(e2 != 255))                  ? ((s1 << 31) | (255 << 23) | (nzm1 << 22) | getBit32(m1, 21, 0)) :
        (((e2 == 255)&&(e1 != 255))                 ? ((s2 << 31) | (255 << 23) | (nzm2 << 22) | getBit32(m2, 21, 0)) :
        (((e1 == 255) && (e2 == 255) && nzm2)       ? ((s2 << 31) | (255 << 23) | (1 << 22) | getBit32(m2, 21, 0)) :
        (((e1 == 255) && (e2 == 255) && nzm1)       ? ((s1 << 31) | (255 << 23) | (1 << 22) | getBit32(m1, 21, 0)) :
